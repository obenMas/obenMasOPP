...
{
    partial class frmCertificateOHTT
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificateOHTT));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificateOHTT1 = new BPS.Certificate.Report.Reports.rptCertificateOHTT();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificateOHTT1;
            ...
            this.Name = "frmCertificateOHTT";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificateOHTT_Load);
        ...
        private Reports.rptCertificateOHTT rptCertificateOHTT1;
    }
}