...
{
    partial class frmCertificatePC
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificatePC));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificatePC1 = new BPS.Certificate.Report.Reports.rptCertificatePC();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificatePC1;
            ...
            this.Name = "frmCertificatePC";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificatePC_Load);
        ...
        private Reports.rptCertificatePC rptCertificatePC1;
    }
}