...
{
    partial class frmCertificateLHTT
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificateLHTT));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificateLHTT1 = new BPS.Certificate.Report.Reports.rptCertificateLHTT();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificateLHTT1;
            ...
            this.Name = "frmCertificateLHTT";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificateLHTT_Load);
        ...
        private Reports.rptCertificateLHTT rptCertificateLHTT1;
    }
}