...
{
    partial class frmCertificatePCX
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificatePCX));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificatePCX1 = new BPS.Certificate.Report.Reports.rptCertificatePCX();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificatePCX1;
            ...
            this.Name = "frmCertificatePCX";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificatePCX_Load);
        ...
        private Reports.rptCertificatePCX rptCertificatePCX1;
    }
}