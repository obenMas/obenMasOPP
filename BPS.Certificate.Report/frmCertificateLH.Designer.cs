...
{
    partial class frmCertificateLH
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificateLH));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificateLH1 = new BPS.Certificate.Report.Reports.rptCertificateLH();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificateLH1;
            ...
            this.Name = "frmCertificateLH";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificateLH_Load);
        ...
        private Reports.rptCertificateLH rptCertificateLH1;
    }
}