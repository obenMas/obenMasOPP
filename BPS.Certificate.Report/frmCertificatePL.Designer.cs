...
{
    partial class frmCertificatePL
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificatePL));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificatePL1 = new BPS.Certificate.Report.Reports.rptCertificatePL();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificatePL1;
            ...
            this.Name = "frmCertificatePL";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificatePL_Load);
        ...
        private Reports.rptCertificatePL rptCertificatePL1;
    }
}