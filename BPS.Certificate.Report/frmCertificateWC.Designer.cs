...
{
    partial class frmCertificateWC
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCertificateWC));
            this.crvCertificateSC = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptCertificateWC1 = new BPS.Certificate.Report.Reports.rptCertificateWC();
            this.SuspendLayout();
            // 
            // crvCertificateSC
            // 
            ...
            this.crvCertificateSC.ReportSource = this.rptCertificateWC1;
            ...
            this.Name = "frmCertificateWC";
            this.Text = "Certificado de Calidad";
            this.Load += new System.EventHandler(this.frmCertificateWC_Load);
        ...
        private Reports.rptCertificateWC rptCertificateWC1;
    }
}