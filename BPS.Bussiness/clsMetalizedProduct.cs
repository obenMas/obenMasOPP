...
namespace BPS.Bussiness
{
    ...
    /// </summary>
    public class clsMetalizedProduct
    {
        //Atributes
        ...
        public clsMetalizedProduct(int codsec)
        {
            this.load(codsec);
        }
        public clsMetalizedProduct(int codsec, bool simple)
        {
            this.load(codsec, true);
        }
        public clsMetalizedProduct(string code)
        {
            this.load(code);
        }
        //Methods
        ...
        public static List<clsProduct> getBoppProductListByFilter(List<clsFilter> lstFilter)
        {
            ...
            DS = clsConnection.getDataSetResult("SELECT * FROM vwProduct WHERE prod_fkBopp > 0 " + where + " ORDER BY prod_name");
        ...
        public static List<clsMetalizedProduct> getListMetalProduct()
        {
            ...
            for (int i = 0; i < DS.Tables[0].Rows.Count; i++)
            {
                lstProduct.Add(new clsMetalizedProduct());
                lstProduct[i].codsec = Convert.ToInt32(DS.Tables[0].Rows[i]["prod_codsec"]);
                lstProduct[i].name = DS.Tables[0].Rows[i]["prod_name"].ToString();
                lstProduct[i].code = DS.Tables[0].Rows[i]["prod_code"].ToString();
            }
