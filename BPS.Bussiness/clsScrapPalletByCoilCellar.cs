...
namespace BPS.Bussiness
{
    public class clsScrapPalletByCoilCellar
    {
        ...
        public clsScrapPalletByCoilCellar(int codsec)
        {
            load(codsec);
        }
        ...
        {
            DataSet DS = clsConnection.getDataSetResult("SELECT * FROM bps_prod_scrappalletbycoilcellar where spbcc_codsec= " + codsec.ToString());
        ...
        public bool save()
        {
            try
            {
                ...
                if (this.codsec == 0)
                {
                    queryString += "INSERT INTO bps_prod_scrappalletbycoilcellar (spbcc_codsec,spbcc_fkScrapPallet,spbcc_fkCoilCellar)";
                    queryString += " VALUES (";
                ...
                else
                {
                    ...
                    queryString += " SET ";
                    queryString += " spbcc_codsec = " + this.codsec.ToString() + ",";
