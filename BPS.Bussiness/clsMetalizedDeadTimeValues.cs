...
{
    public class clsMetalizedDeadTimeValues
    {
        //Attributes
        private int mtodt_codsec;
        private int mtodt_fkOrder;
        private clsMetallizedOrder mtodt_Order;
        ...
        public clsMetallizedOrder Order { get { return mtodt_Order; } set { mtodt_Order = value; } }
        ...
        public bool save()
        {
            try
            {
                ...
                if (this.codsec == 0)
                {
                    queryString += "INSERT INTO bps_prod_deadtimemetalized (mtodt_fkOrder, mtodt_fkDeadTime, mtodt_initdate, mtodt_enddate, mtodt_totaldeadtime)";
                    queryString += " VALUES (";
                ...
                {
                    queryString += "UPDATE bps_prod_deadtimemetalized";
                    queryString += " SET ";
        ...
        public static List<clsMetalizedDeadTimeValues> getListByMainCoilMetal(int codsec)
        {
            List<clsMetalizedDeadTimeValues> lstDeadTimeType = new List<clsMetalizedDeadTimeValues>();

            DataSet DS = new DataSet();

            DS = clsConnection.getDataSetResult("spMetalizedPresionDeadTime " + codsec.ToString() + ", 'DeadTimeByMainCoil'");
