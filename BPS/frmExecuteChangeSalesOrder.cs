    ...
    public partial class frmExecuteChangeSalesOrder : Form
    {
        ...
        public void fillSummary()
        {
            ...
            for (int i = 0; i < lstChangeSalesOrder.Count; i++)
            {
                ...
                dgvChangeOrderSummary.Rows[i].Cells[clmChangeOrderStatus.Index].Value = (lstChangeSalesOrder[i].statusName == "Activa") ? global::BPS.Properties.Resources.calendar_2 : global::BPS.Properties.Resources.play_sharp;
                dgvChangeOrderSummary.Rows[i].Cells[clmChangeOrderClose.Index].Value = global::BPS.Properties.Resources.lock1;
            }
        }
        ...
        private void dgvChangeOrderSummary_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == clmChangeOrderStatus.Index)
            {
                ...
                for (int i = 0; i < lstCoils.Count; i++)
                {
                    ...
                    dgvCoils.Rows[i].Cells[clmCoilCodsec.Index].Value = global::BPS.Properties.Resources.cross;
                }
        ...
        private void btnAddCoil_Click(object sender, EventArgs e)
        {
            ...
            if (objCoil.codsec != 0)
            {
                if (objCoil.coilCellarContainer.codsec == 3 || objCoil.coilCellarContainer.codsec == 4 || objCoil.coilCellarContainer.codsec == 8 || objCoil.coilCellarContainer.name == "Producto Terminado" || objCoil.coilCellarContainer.name == "Stock Local" || objCoil.coilCellarContainer.name == "Stock Perú")
