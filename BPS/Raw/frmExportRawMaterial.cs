...
namespace BPS.Raw
{
    public partial class frmExportRawMaterial : Form
    {
        ...
        public frmExportRawMaterial()
        {
            InitializeComponent();
            getPalletList();
        }

        private void frmExportRawMaterial_Load(object sender, EventArgs e)
        {
        ...
        private void loadMovements()
        {
            ...
            rawList = clsRawMaterialbyCoilCellar.getMovementListByDate(dtpInitDate.Value, dtpEndDate.Value);
