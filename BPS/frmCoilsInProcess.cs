...
namespace BPS
{
    public partial class frmCoilsInProcess : Form
    {
        ...
        {
            DS = clsConnection.getDataSetResult("SELECT * FROM vwInProcessProduct WHERE Bodega='Producto en Proceso' OR Bodega='Producto en Proceso Pilar'");
        }
            ...
            if (DS.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < DS.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (concat == concat2)
                    {
                        ...
                        {
                            if (DS.Tables[0].Rows[i]["Planta"].ToString() == "Pilar" && (DS.Tables[0].Rows[i]["Bodega"].ToString() == "Producto en Proceso Pilar"))
                            {
                                ...
                                startday = Convert.ToDateTime(DS.Tables[0].Rows[i]["Antiguedad"]);
                               
                                diference = (enddate - startday).TotalHours;

                                dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmDate.Index].Value = diference;
                                if(diference >24)
                                {
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCodsec.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCode.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmProduct.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCustommer.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmOrder.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmNetWeight.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmQuality.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCutDate.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCellar.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmPlant.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmDestination.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmProcess.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmUsefulwidth.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmDetail.Index].Style.BackColor = Color.Red;
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmDate.Index].Style.BackColor = Color.Red;
                                }
                        ...
                        else
                        {
                            ...
                            {
                                if (DS.Tables[0].Rows[i]["Planta"].ToString() == "Campana" && (DS.Tables[0].Rows[i]["Bodega"].ToString() == "Producto en Proceso"))
                                {
                                    dgvCoilsWithoutPallets.Rows.Add();
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCodsec.Index].Value = Convert.ToInt32(DS.Tables[0].Rows[i]["codsec"]);
                                    dgvCoilsWithoutPallets.Rows[dgvCoilsWithoutPallets.Rows.Count - 1].Cells[clmCode.Index].Value = DS.Tables[0].Rows[i]["Codigo"].ToString();
