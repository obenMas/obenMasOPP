...
{
    public partial class frmInternationalSummarySalesOrder : Form
    {
        ...
        private void loadMovements()
        {
            ...
            lstSalesOrder = clsSummarySalesOrder.getListInternationalSummarySalesOrder();
        ...
        public frmInternationalSummarySalesOrder()
        {
            InitializeComponent();
            getPalletList();
        }
        ...
        private void fillPalletInfo()
        {
            ...
            if (executeFilter == true)
            {
                ...
                for (int i = 0; i < lstSalesOrder.Count; i++)
                {
                    ...
                    if (cmbFilm.Text != "" || cmbOrder.Text != "" || cmbFilm.SelectedIndex > -1 || cmbOrder.SelectedIndex > -1 || (txtWidth.Text != "" && txtWidth.Text != "0") || cmbCustomer.Text != string.Empty || cmbCustomer.SelectedIndex > -1 || chkExtrusionDate.Checked == true)
                    {
                        //Film
                        ...
                        if (flgOKFilm == true && flgOKSalesOrder == true && flgOKWidth == true && flgOKCustomers == true && flgOKExtrusionDate == true)
                            flgInclude = true;
                    }
                    else
                        flgInclude = true;
        ...
        private void frmInternationalSummarySalesOrder_Load(object sender, EventArgs e)
        {
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                worksheet.Name = "Pedidos Internacionales";
