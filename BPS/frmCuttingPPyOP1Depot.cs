...
namespace BPS
{
    public partial class frmCuttingPPyOP1Depot : Form
    {
        ...
        {
            DS = clsConnection.getDataSetResult("SELECT * FROM vwDepositoPP");
            DS2 = clsConnection.getDataSetResult("SELECT * FROM vwDepositoOP1");
            DS3 = clsConnection.getDataSetResult("SELECT * FROM vwDepositoCorte");
        }
        ...
        private void llenardgv()
        {
            ...
            if (DS2.Tables.Count > 0)
            {
                for (int i = 0; i < DS2.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (plantafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Planta"]);
                    }
                    if (bodegafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Bodega"]);
                    }
                    if (clasificacionfiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Clasificación"]);
                    }
                    if (palletfiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Pallet"]);
                    }
                    if (bobinafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Bobina"]);
                    }
                    if (peliculafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Pelicula"]);
                    }
                    if (anchofiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Ancho"]);
                    }
                    if (diametrofiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Diametro"]);
                    }
                    if (corefiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Core"]);
                    }
                    if (clientefiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Cliente"]);
                    }
                    if (pedidofiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Pedido"]);
                    }
                    if (posicionfiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS2.Tables[0].Rows[i]["Posicion"]);
                    }
                    if (concat == concat2)
                    {
                        dgv.Rows.Add();
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Fecha.Index].Value = Convert.ToDateTime(DS2.Tables[0].Rows[i]["Fecha"]).ToShortDateString();
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Planta.Index].Value = DS2.Tables[0].Rows[i]["Planta"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Bodega.Index].Value = DS2.Tables[0].Rows[i]["Bodega"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Clasificacion.Index].Value = DS2.Tables[0].Rows[i]["Clasificación"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Origen.Index].Value = DS2.Tables[0].Rows[i]["Origen"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Pallet.Index].Value = DS2.Tables[0].Rows[i]["Pallet"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Bobina.Index].Value = DS2.Tables[0].Rows[i]["Bobina"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Pelicula.Index].Value = DS2.Tables[0].Rows[i]["Pelicula"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Ancho.Index].Value = DS2.Tables[0].Rows[i]["Ancho"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Diametro.Index].Value = DS2.Tables[0].Rows[i]["Diametro"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Core.Index].Value = DS2.Tables[0].Rows[i]["Core"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Cliente.Index].Value = DS2.Tables[0].Rows[i]["Cliente"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Pedido.Index].Value = DS2.Tables[0].Rows[i]["Pedido"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[PesoNeto.Index].Value = DS2.Tables[0].Rows[i]["PesoNetoActual"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Calificacion.Index].Value = DS2.Tables[0].Rows[i]["Calificación"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Observaciones.Index].Value = DS2.Tables[0].Rows[i]["Observaciones"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Posicion.Index].Value = DS2.Tables[0].Rows[i]["Posicion"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Destino.Index].Value = DS2.Tables[0].Rows[i]["DestinoRevision"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Reproceso.Index].Value = DS2.Tables[0].Rows[i]["Reproceso"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[AnchoUtil.Index].Value = DS2.Tables[0].Rows[i]["AnchoUtil"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[DetalleRevision.Index].Value = DS2.Tables[0].Rows[i]["DetalleRevision"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[UsuarioRevision.Index].Value = DS2.Tables[0].Rows[i]["UsuarioRevision"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[FechaRevision.Index].Value = Convert.ToDateTime(DS2.Tables[0].Rows[i]["FechaRevision"]).ToShortDateString();

                        if (!plantas.Contains(DS2.Tables[0].Rows[i]["Planta"].ToString()))
                        {
                            plantas.Add(DS2.Tables[0].Rows[i]["Planta"].ToString());
                        }
                        if (!bodegas.Contains(DS2.Tables[0].Rows[i]["Bodega"].ToString()))
                        {
                            bodegas.Add(DS2.Tables[0].Rows[i]["Bodega"].ToString());
                        }
                        if (!clasificaciones.Contains(DS2.Tables[0].Rows[i]["Clasificación"].ToString()))
                        {
                            clasificaciones.Add(DS2.Tables[0].Rows[i]["Clasificación"].ToString());
                        }
                        if (!pallets.Contains(DS2.Tables[0].Rows[i]["Pallet"].ToString()))
                        {
                            pallets.Add(DS2.Tables[0].Rows[i]["Pallet"].ToString());
                        }
                        if (!bobinas.Contains(DS2.Tables[0].Rows[i]["Bobina"].ToString()))
                        {
                            bobinas.Add(DS2.Tables[0].Rows[i]["Bobina"].ToString());
                        }
                        if (!peliculas.Contains(DS2.Tables[0].Rows[i]["Pelicula"].ToString()))
                        {
                            peliculas.Add(DS2.Tables[0].Rows[i]["Pelicula"].ToString());
                        }
                        if (!anchos.Contains(DS2.Tables[0].Rows[i]["Ancho"].ToString()))
                        {
                            anchos.Add(DS2.Tables[0].Rows[i]["Ancho"].ToString());
                        }
                        if (!diametros.Contains(DS2.Tables[0].Rows[i]["Diametro"].ToString()))
                        {
                            diametros.Add(DS2.Tables[0].Rows[i]["Diametro"].ToString());
                        }
                        if (!cores.Contains(DS2.Tables[0].Rows[i]["Core"].ToString()))
                        {
                            cores.Add(DS2.Tables[0].Rows[i]["Core"].ToString());
                        }
                        if (!clientes.Contains(DS2.Tables[0].Rows[i]["Cliente"].ToString()))
                        {
                            clientes.Add(DS2.Tables[0].Rows[i]["Cliente"].ToString());
                        }
                        if (!pedidos.Contains(DS2.Tables[0].Rows[i]["Pedido"].ToString()))
                        {
                            pedidos.Add(DS2.Tables[0].Rows[i]["Pedido"].ToString());
                        }
                        if (!posiciones.Contains(DS2.Tables[0].Rows[i]["Posicion"].ToString()))
                        {
                            posiciones.Add(DS2.Tables[0].Rows[i]["Posicion"].ToString());
                        }
                    }
                }
            }
            ...
            if (DS3.Tables.Count > 0)
            {
                for (int i = 0; i < DS3.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (plantafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Planta"]);
                    }
                    if (bodegafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Bodega"]);
                    }
                    if (clasificacionfiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Clasificación"]);
                    }
                    if (palletfiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Pallet"]);
                    }
                    if (bobinafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Bobina"]);
                    }
                    if (peliculafiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Pelicula"]);
                    }
                    if (anchofiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Ancho"]);
                    }
                    if (diametrofiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Diametro"]);
                    }
                    if (corefiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Core"]);
                    }
                    if (clientefiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Cliente"]);
                    }
                    if (pedidofiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Pedido"]);
                    }
                    if (posicionfiltrado != string.Empty)
                    {
                        concat2 += Convert.ToString(DS3.Tables[0].Rows[i]["Posicion"]);
                    }
                    if (concat == concat2)
                    {
                        dgv.Rows.Add();
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Fecha.Index].Value = Convert.ToDateTime(DS3.Tables[0].Rows[i]["Fecha"]).ToShortDateString();
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Planta.Index].Value = DS3.Tables[0].Rows[i]["Planta"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Bodega.Index].Value = DS3.Tables[0].Rows[i]["Bodega"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Clasificacion.Index].Value = DS3.Tables[0].Rows[i]["Clasificación"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Origen.Index].Value = DS3.Tables[0].Rows[i]["Origen"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Pallet.Index].Value = DS3.Tables[0].Rows[i]["Pallet"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Bobina.Index].Value = DS3.Tables[0].Rows[i]["Bobina"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Pelicula.Index].Value = DS3.Tables[0].Rows[i]["Pelicula"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Ancho.Index].Value = DS3.Tables[0].Rows[i]["Ancho"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Diametro.Index].Value = DS3.Tables[0].Rows[i]["Diametro"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Core.Index].Value = DS3.Tables[0].Rows[i]["Core"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Cliente.Index].Value = DS3.Tables[0].Rows[i]["Cliente"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Pedido.Index].Value = DS3.Tables[0].Rows[i]["Pedido"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[PesoNeto.Index].Value = DS3.Tables[0].Rows[i]["PesoNetoActual"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Calificacion.Index].Value = DS3.Tables[0].Rows[i]["Calificación"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Observaciones.Index].Value = DS3.Tables[0].Rows[i]["Observaciones"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Posicion.Index].Value = DS3.Tables[0].Rows[i]["Posicion"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Destino.Index].Value = DS3.Tables[0].Rows[i]["DestinoRevision"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[Reproceso.Index].Value = DS3.Tables[0].Rows[i]["Reproceso"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[AnchoUtil.Index].Value = DS3.Tables[0].Rows[i]["AnchoUtil"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[DetalleRevision.Index].Value = DS3.Tables[0].Rows[i]["DetalleRevision"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[UsuarioRevision.Index].Value = DS3.Tables[0].Rows[i]["UsuarioRevision"];
                        dgv.Rows[dgv.Rows.Count - 1].Cells[FechaRevision.Index].Value = Convert.ToDateTime(DS3.Tables[0].Rows[i]["FechaRevision"]).ToShortDateString();

                        if (!plantas.Contains(DS3.Tables[0].Rows[i]["Planta"].ToString()))
                        {
                            plantas.Add(DS3.Tables[0].Rows[i]["Planta"].ToString());
                        }
                        if (!bodegas.Contains(DS3.Tables[0].Rows[i]["Bodega"].ToString()))
                        {
                            bodegas.Add(DS3.Tables[0].Rows[i]["Bodega"].ToString());
                        }
                        if (!clasificaciones.Contains(DS3.Tables[0].Rows[i]["Clasificación"].ToString()))
                        {
                            clasificaciones.Add(DS3.Tables[0].Rows[i]["Clasificación"].ToString());
                        }
                        if (!pallets.Contains(DS3.Tables[0].Rows[i]["Pallet"].ToString()))
                        {
                            pallets.Add(DS3.Tables[0].Rows[i]["Pallet"].ToString());
                        }
                        if (!bobinas.Contains(DS3.Tables[0].Rows[i]["Bobina"].ToString()))
                        {
                            bobinas.Add(DS3.Tables[0].Rows[i]["Bobina"].ToString());
                        }
                        if (!peliculas.Contains(DS3.Tables[0].Rows[i]["Pelicula"].ToString()))
                        {
                            peliculas.Add(DS3.Tables[0].Rows[i]["Pelicula"].ToString());
                        }
                        if (!anchos.Contains(DS3.Tables[0].Rows[i]["Ancho"].ToString()))
                        {
                            anchos.Add(DS3.Tables[0].Rows[i]["Ancho"].ToString());
                        }
                        if (!diametros.Contains(DS3.Tables[0].Rows[i]["Diametro"].ToString()))
                        {
                            diametros.Add(DS3.Tables[0].Rows[i]["Diametro"].ToString());
                        }
                        if (!cores.Contains(DS3.Tables[0].Rows[i]["Core"].ToString()))
                        {
                            cores.Add(DS3.Tables[0].Rows[i]["Core"].ToString());
                        }
                        if (!clientes.Contains(DS3.Tables[0].Rows[i]["Cliente"].ToString()))
                        {
                            clientes.Add(DS3.Tables[0].Rows[i]["Cliente"].ToString());
                        }
                        if (!pedidos.Contains(DS3.Tables[0].Rows[i]["Pedido"].ToString()))
                        {
                            pedidos.Add(DS3.Tables[0].Rows[i]["Pedido"].ToString());
                        }
                        if (!posiciones.Contains(DS3.Tables[0].Rows[i]["Posicion"].ToString()))
                        {
                            posiciones.Add(DS3.Tables[0].Rows[i]["Posicion"].ToString());
                        }
                    }
                }
            }
