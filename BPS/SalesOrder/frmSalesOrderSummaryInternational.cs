...
namespace BPS
{
    public partial class frmSalesOrderSummaryInternational : Form
    {
        ...
        private void loadMovements()
        {
            ...
            lstSalesOrder = clsSummarySalesOrder.getListInternational();
        ...
        public frmSalesOrderSummaryInternational()
        {
            InitializeComponent();
            getPalletList();
        }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Exportación Generada correctamente... Por favor revisar el EXCEL", "Pedidos Internacionales", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Pedidos Internacionales", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
