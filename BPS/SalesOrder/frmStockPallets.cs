...
namespace BPS
{
    public partial class frmStockPallets : Form
    {
        ...
        private void loadMovements()
        {
            ...
            //BackloadListThread = new Thread(delegate() { lstPallets = clsPallet.getListForBackLoad(); });
            //BackloadListThread.Start();
            lstPallets = clsPallet.getListStockPallet();
            ...
            if (executeFilter == true)
            {
                ...
                for (int i = 0; i < lstPallets.Count; i++)
                {
                    ...
                    if (flgInclude == true)
                    {
                        ...
                        dgvDetails.Rows[dgvDetails.Rows.Count - 1].Cells[clmproductfilm.Index].Value = lstPallets[i].filmName;
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                worksheet.Name = "Pallet en Stock";
                ...
                MessageBox.Show("Exportación Generada correctamente... Por favor revisar el EXCEL", "Pallet´s en STOCK", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Pallet´s en STOCK", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
