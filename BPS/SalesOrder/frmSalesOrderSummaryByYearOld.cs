...
namespace BPS
{
    public partial class frmSalesOrderSummaryByYearOld : Form
    {
        ...
        private void loadMovements()
        {
            ...
            lstSalesOrder = clsSummarySalesOrder.getListByYear();
        ...
        public frmSalesOrderSummaryByYearOld()
        {
            InitializeComponent();
            getPalletList();
        }
        ...
        private void frmSalesOrderSummaryByYearOld_Load(object sender, EventArgs e)
        {
