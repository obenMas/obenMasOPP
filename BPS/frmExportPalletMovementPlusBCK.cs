...
namespace BPS
{
    public partial class frmExportPalletMovementPlusBCK : Form
    {
        ...
        private void loadMovements()
        {
            ...
            lstPallet = clsPalletbyCoilCellar.getListMovementByDateNoShipping(dtpInitDate.Value, dtpEndDate.Value, movementload);
        ...
        public frmExportPalletMovementPlusBCK()
        {
            InitializeComponent();
            getPalletList();
        }
            ...
            if (executeFilter == true)
            {
                ...
                for (int i = 0; i < lstPallet.Count; i++)
                {
                    ...
                    if (cmbProduct.Text != "" || cmbCustomer.Text != "" || cmbOrder.Text != "" || cmbProduct.SelectedIndex > -1 || cmbCustomer.SelectedIndex > -1 || cmbOrder.SelectedIndex > -1 || cmbMovement.Text != "" || cmbMovement.SelectedIndex > -1)
                    {
                        ...
                        //{
                        //    if (lstPallet[i].origin.ToUpper() == cmbOrigin.SelectedItem.ToString().ToUpper())
                        //        flgOKOrigin = true;
                        //}
                        //if (cmbOrigin.SelectedIndex == -1)
                        //    flgOKOrigin = true;
                        ...
                        //{
                        //    if (lstPallet[i].createdDate >= dtpInitDate.Value && lstPallet[i].createdDate <= dtpEndDate.Value)
                        //    {
                        ...
                        //    {
                        //        if (lstPallet[i].coilCellarName.ToUpper().StartsWith(lstbCoilCellar.SelectedItems[j].ToString().ToUpper()))
                        ...
                        //    {
                        //        if (lstPallet[i].product.width >= Convert.ToInt32(txtWidthFrom.Text) && lstPallet[i].product.width <= Convert.ToInt32(txtWidthTo.Text))
                        //            flgOKWidth = true;
                        //    }
                        //    else
                        //    {
                        //        if (lstPallet[i].product.width == Convert.ToInt32(txtWidthFrom.Text))
                        //            flgOKWidth = true;
                        //    }
                        //}
                        //else
                        ...
                        //{
                        //    TimeSpan ts = DateTime.Now - lstPallet[i].extrusionDate;
        ...
        private void frmExportPalletMovementPlusBCK_Load(object sender, EventArgs e)
        {
        ...
        private void btnLoadData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Debe seleccionar un movimiento antes de poder visualizar los datos", "Exportación de Movimientos al Siigo", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign, false);
