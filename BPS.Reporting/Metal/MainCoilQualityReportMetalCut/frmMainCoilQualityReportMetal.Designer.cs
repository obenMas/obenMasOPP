...
{
    partial class frmMainCoilQualityReportMetal
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMainCoilQualityReportMetal));
            this.crvQualityReport = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
            this.rptMainCoilQualityMetal1 = new BPS.Reporting.Metal.MainCoilQualityReportMetalCut.rptMainCoilQualityMetal();
            this.SuspendLayout();
            // 
            // crvQualityReport
            // 
            ...
            this.crvQualityReport.ReportSource = this.rptMainCoilQualityMetal1;
            ...
            this.Name = "frmMainCoilQualityReportMetal";
        ...
        private BPS.Reporting.Metal.MainCoilQualityReportMetalCut.rptMainCoilQualityMetal rptMainCoilQualityMetal1;
    }
}