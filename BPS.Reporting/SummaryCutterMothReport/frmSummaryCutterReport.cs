...
{
    public partial class frmSummaryCutterReport : Form
    {
        ...
        public frmSummaryCutterReport()
        {
            InitializeComponent();
        }

        public frmSummaryCutterReport(string password)
        {
            InitializeComponent();
        ...
        private void loadReports()
        {
            try
            {
                ...
                crvSummaryExtruder.ReportSource = rptCutter;
            }
            catch (Exception ex)
            {
