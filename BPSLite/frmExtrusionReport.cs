        ...
        private void btnGenerateCuttingRp_Click(object sender, EventArgs e)
        {
            ...
            if(DS.Tables.Count>0 && DS.Tables[0].Rows.Count>0)
            {
                for(int i=0;i<DS.Tables[0].Rows.Count;i++)
                {
                    ...
                    dataGridView1.Rows[fila].Cells[Maquina.Index].Value = DS.Tables[0].Rows[i]["Extrusora"].ToString();
                    ...
                    dataGridView1.Rows[fila].Cells[Usuario.Index].Value = DS.Tables[0].Rows[i]["Usuario"].ToString();
                    dataGridView1.Rows[fila].Cells[Fecha.Index].Value = Convert.ToDateTime(DS.Tables[0].Rows[i]["Fecha"]).ToString("dd/MM/yyyy HH:mm");
                    dataGridView1.Rows[fila].Cells[clmDay.Index].Value = DS.Tables[0].Rows[i]["dayFecha"];
                    dataGridView1.Rows[fila].Cells[clmMonth.Index].Value = DS.Tables[0].Rows[i]["monthFecha"];
                    dataGridView1.Rows[fila].Cells[clmYear.Index].Value = DS.Tables[0].Rows[i]["yearFecha"];
