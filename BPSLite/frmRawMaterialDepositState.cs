...
namespace BPS.Lite
{
    ...
    {        
            ...
            if (DS.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < DS.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (concat == concat2)
                    {
                        ...
                        dgvStockRaw.Rows[dgvStockRaw.Rows.Count - 1].Cells[clmDay.Index].Value = DS.Tables[0].Rows[i]["dayFecha"];
                        dgvStockRaw.Rows[dgvStockRaw.Rows.Count - 1].Cells[clmMonth.Index].Value = DS.Tables[0].Rows[i]["monthFecha"];
                        dgvStockRaw.Rows[dgvStockRaw.Rows.Count - 1].Cells[clmYear.Index].Value = DS.Tables[0].Rows[i]["yearFecha"];
                        dgvStockRaw.Rows[dgvStockRaw.Rows.Count - 1].Cells[clmHour.Index].Value = DS.Tables[0].Rows[i]["Hora"];
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            dgvStockRaw.Columns["clmFecha"].Visible = false;
            dgvStockRaw.Columns["clmDay"].Visible = true;
            dgvStockRaw.Columns["clmMonth"].Visible = true;
            dgvStockRaw.Columns["clmYear"].Visible = true;
            dgvStockRaw.Columns["clmHour"].Visible = true;
            ...
            dgvStockRaw.Columns["clmDay"].Visible = false;
            dgvStockRaw.Columns["clmMonth"].Visible = false;
            dgvStockRaw.Columns["clmYear"].Visible = false;
            dgvStockRaw.Columns["clmHour"].Visible = false;
            dgvStockRaw.Columns["clmPlanta"].Visible = true;
            dgvStockRaw.Columns["clmCodigoM"].Visible = true;
            dgvStockRaw.Columns["clmBodega"].Visible = true;
   ...
   /*
            if (lastChange != "codigosilo")
            {
                cmbCodMatSilo.Items.Clear();
            }*/
             ...
             if (DS.Tables.Count > 0)
            {
                for (int i = 0; i < DS.Tables[0].Rows.Count; i++)
                {
                     ...
                     if (concat == concat2)
                    {
                        ...
                        //dgvSilo.Rows[dgvSilo.Rows.Count - 1].Cells[clmSiloLote.Index].Value = Convert.ToString(DS.Tables[0].Rows[i]["lote"]); 
                        dgvSilo.Rows[dgvSilo.Rows.Count - 1].Cells[clmSiloPlanta.Index].Value = Convert.ToString(DS.Tables[0].Rows[i]["planta"]);
                     

                        /*if (!codigosSilo.Contains(Convert.ToString(DS.Tables[0].Rows[i]["codRawMat"])))
                            codigosSilo.Add(Convert.ToString(DS.Tables[0].Rows[i]["codRawMat"]));
                         */
                ...
                /*if (lastChange != "codigosilo")
                {
                    for (int i = 0; i < codigosSilo.Count; i++)
                    {
                        cmbCodMatSilo.Items.Add(codigosSilo[i]);
                    }
                }*/
                if (lastChange != "tipomaterialsilo")
                {
             ...
             txtTotSilo.Text = Math.Round(pesos, 2).ToString();
        }
        

        /*private void cmbCodMatSilo_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cmbCodMatSilo.SelectedIndex != -1)
            {
                if (codigoSilo != cmbCodMatSilo.SelectedItem.ToString())
                {
                    codigoSilo = cmbCodMatSilo.SelectedItem.ToString();
                    lastChange = "codigosilo";
                    populateDgvSilo();
                }
            }
            else
        ...
        #region Exportar a Excel Total Pallets
