...
namespace BPS.Lite
{
    public partial class frmStockPalletsRegistration : Form
    {
        ...
        public frmStockPalletsRegistration()
        {
            InitializeComponent();
        }
        ...
        public frmStockPalletsRegistration(int cuttingOrderCodsec, string loadBy)
        {
            LoadedAs = loadBy;
            InitializeComponent();
            switch (loadBy)
        ...
        private void loadTree()
        {
            ...
            trvDestinations.Nodes.Add(clsSalesOrderPalletsTree.getTreeByActiveCuttingOrdersWithStock());
