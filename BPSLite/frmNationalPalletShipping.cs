...
namespace BPS
{
    public partial class frmNationalPalletShipping : Form
    {
        ...
        private void txtPalletCode_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                clsPallet objpallet = clsPallet.getCompleteDetailByCode(txtPalletCode.Text);
                if(objpallet.fkStatus != clsStatus.getStatusByStatusGroupNameAndStatusName("Pallets","Despachado").codsec && objpallet.codsec!=0)
                {
                    ...
                    if(dgvPalletList.Rows.Count>0)
                    {
                        ...
                        {
                            if(dgvPalletList.Rows[i].Cells[clmCode.Index].Value.ToString() == txtPalletCode.Text)
                            {
                                coincidence = true;
                            }
                        }
                    ...
                    if(!coincidence)
                    {
                        if (clsPallet.getPalletValidate(txtPalletCode.Text, true) == "OK")
                        {
                            if (dgvPalletList.Rows.Count == 0)
                            {
                                ...
                                dgvPalletList.Rows[0].Cells[clmimage.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                                dgvPalletList.Rows[0].Cells[clmblock.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                            ...
                            else
                            {
                                ...
                                dgvPalletList.Rows[dgvPalletList.Rows.Count - 1].Cells[clmimage.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                                dgvPalletList.Rows[dgvPalletList.Rows.Count - 1].Cells[clmblock.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                        ...
                        else
                        {
                            if (dgvPalletList.Rows.Count == 0)
                            {
                                ...
                                dgvPalletList.Rows[0].Cells[clmCode.Index].Value = txtPalletCode.Text;
                                dgvPalletList.Rows[0].Cells[clmStatus.Index].Value = "Por despachar";
                                dgvPalletList.Rows[0].Cells[clmimage.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                                dgvPalletList.Rows[0].Cells[clmblock.Index].Value = global::BPS.Lite.Properties.Resources.key;
                            ...
                            else
                            {
                                ...
                                dgvPalletList.Rows[dgvPalletList.Rows.Count - 1].Cells[clmCode.Index].Value = txtPalletCode.Text;
                                dgvPalletList.Rows[dgvPalletList.Rows.Count - 1].Cells[clmStatus.Index].Value = "Por despachar";
                                dgvPalletList.Rows[dgvPalletList.Rows.Count - 1].Cells[clmimage.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                                dgvPalletList.Rows[dgvPalletList.Rows.Count - 1].Cells[clmblock.Index].Value = global::BPS.Lite.Properties.Resources.key;
                    ...
                    {
                        MessageBox.Show("No se puede generar el despacho del pallet " + txtPalletCode.Text + ". Esto puede suceder por los siguientes motivos: \n"
                        + "-El pallet ya está despachado.\n-El pallet no existe en el sistema.\n-El pallet ya está en la lista.", "Reporte de devoluciones", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
            ...
            try
            {
                ...
                if (MessageBox.Show("¿Está seguro que se desea despachar los pallets ingresados?", "Despacho", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
                {
                    ...
                    for (int i = 0; i < dgvPalletList.Rows.Count; i++)
                    {
                        ...
                        // Se agrega el movimiento para poder darle mas trazabilidad a los despachos. 

                        pallet = clsPallet.getDetailByCode(dgvPalletList.Rows[i].Cells[clmCode.Index].Value.ToString());
                        ...
                        movimientoPallet.type = "Se despacho el pallet " + pallet.code;
                        movimientoPallet.fkDestCellar = 40;
                        movimientoPallet.fkOrigCellar = pallet.fkCoilCellar;
                        movimientoPallet.save();
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (clsMaquile.getMaquileByCode(txtMaquileCode.Text))
                {
                    ...
                    if (dgvMaquile.Rows.Count == 0)
                    {
                        ...
                        dgvMaquile.Rows[0].Cells[clmmaquilestatus.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                        dgvMaquile.Rows[0].Cells[clmmaquiledelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                    ...
                    else
                    {
                        ...
                        dgvMaquile.Rows[dgvMaquile.Rows.Count - 1].Cells[clmmaquilestatus.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                        dgvMaquile.Rows[dgvMaquile.Rows.Count - 1].Cells[clmmaquiledelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                ...
                else
                {
                    ...
                    dgvMaquile.Rows[dgvMaquile.Rows.Count - 1].Cells[clmmaquilestatus.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                    dgvMaquile.Rows[dgvMaquile.Rows.Count - 1].Cells[clmmaquiledelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
        ...
        private void RealaodMaquile(List<stctMyMaquile> lstMyMaquile)
        {
            ...
            for (int i = 0; i < lstMyMaquile.Count; i++)
            {
                ...
                dgvMaquile.Rows[i].Cells[clmmaquilestatus.Index].Value = global::BPS.Lite.Properties.Resources.check;
                dgvMaquile.Rows[i].Cells[clmmaquiledelete.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                ...
                if (ValidateForm())
                {
                    if (clsMillPallet.getMillPalletByCode(txtReProcessCode.Text))
                    {
                        ...
                        if (dgvReprocess.Rows.Count == 0)
                        {
                            ...
                            dgvReprocess.Rows[0].Cells[clmreprocesscheck.Index].Value = global::BPS.Lite.Properties.Resources.clear;
                            dgvReprocess.Rows[0].Cells[clmreprocessdelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                        ...
                        else
                        {
                            ...
                            dgvReprocess.Rows[dgvReprocess.Rows.Count - 1].Cells[clmreprocessdelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                    ...
                    else
                    {
                        ...
                        dgvReprocess.Rows[dgvReprocess.Rows.Count - 1].Cells[clmreprocesscheck.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                        dgvReprocess.Rows[dgvReprocess.Rows.Count - 1].Cells[clmreprocessdelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
        ...
        /*private void RealaodMill(List<stctMyMill> lstMyill)
        {
            ...
            for (int i = 0; i < lstMyill.Count; i++)
            {
                ...
                dgvReprocess.Rows[dgvReprocess.Rows.Count - 1].Cells[clmreprocesscheck.Index].Value = global::BPS.Lite.Properties.Resources.check;
                dgvReprocess.Rows[dgvReprocess.Rows.Count - 1].Cells[clmreprocessdelete.Index].Value = global::BPS.Lite.Properties.Resources.clear;
