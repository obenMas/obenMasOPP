            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (txtCodigo.Text != string.Empty)
                {
                    ...
                    if (rawPallet.codsec != 0)
                    {
                        ...
                        {
                            if (rawPallet.fkRaw == 255 || rawPallet.fkRaw == 276 || rawPallet.fkRaw == 277 || rawPallet.fkRaw == 278 || rawPallet.fkRaw == 279 || rawPallet.fkRaw == 292 || rawPallet.fkRaw == 293 || rawPallet.fkRaw == 294 || rawPallet.fkRaw == 295 || rawPallet.fkRaw == 303 || rawPallet.fkRaw == 332 || rawPallet.fkRaw == 333 || rawPallet.fkRaw == 282 || rawPallet.fkRaw == 302 || rawPallet.fkRaw == 332 || rawPallet.fkRaw == 336)
                            {
