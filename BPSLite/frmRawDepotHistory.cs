            ...
            if (DS.Tables.Count > 0 && DS.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < DS.Tables[0].Rows.Count; i++)
                {
                    if (Convert.ToDouble(DS.Tables[0].Rows[i]["rdh_netweight"]) != 0)
                    {
                        ...
                        dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[Day.Index].Value = DS.Tables[0].Rows[i]["rdh_day"].ToString();
                        dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[Month.Index].Value = DS.Tables[0].Rows[i]["rdh_month"].ToString();
                        dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[Year.Index].Value = DS.Tables[0].Rows[i]["rdh_year"].ToString();
                        clsRawMaterial rawmat = new clsRawMaterial();
                        rawmat.loadByCode(DS.Tables[0].Rows[i]["rdh_raw"].ToString());
                        dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[MaterialCode.Index].Value = rawmat.name;
                        if (Convert.ToDouble(DS.Tables[0].Rows[i]["rdh_netweight"]) >= 10000)
                        {
                            dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[ActualWeight.Index].Value = Convert.ToDouble(DS.Tables[0].Rows[i]["rdh_netweight"]).ToString("0000.00");
                        }
                        else
                        {
                            dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[ActualWeight.Index].Value = Convert.ToDouble(DS.Tables[0].Rows[i]["rdh_netweight"]).ToString("000.00");
                        }
                        ...
                        dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells[CoilCellar.Index].Value = DS.Tables[0].Rows[i]["rdh_coilcellar"].ToString();
                    }
                }
            }
            else
