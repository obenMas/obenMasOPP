        ...
        private void PopulateRequest()
        {
            ...
            if (lstRequestUser.Count > 0)
            {
                for (int i = 0; i < lstRequestUser.Count; i++)
                {
                    ...
                    dgvRequestList.Rows[i].Cells[clmrequestedit.Index].Value = global::BPS.Lite.Properties.Resources.pencil;
                    dgvRequestList.Rows[i].Cells[clmrequestdelete.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                    dgvRequestList.Rows[i].Cells[clmrequestok.Index].Value = global::BPS.Lite.Properties.Resources.Up;
                    dgvRequestList.Rows[i].Cells[clmrequestnot.Index].Value = global::BPS.Lite.Properties.Resources.Down;
                    dgvRequestList.Rows[i].Cells[clmrequestview.Index].Value = global::BPS.Lite.Properties.Resources.eye;
                    dgvRequestList.Rows[i].Cells[clmrequestreport.Index].Value = global::BPS.Lite.Properties.Resources.report;
