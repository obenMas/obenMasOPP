...
namespace BPS.Lite
{
    public partial class frmMetallizedOrderReaload : Form
    {
        ...
        private void loadMovements()
        {
            ...
            lstBopp = clsBopp.getListBaseFilm();
        ...
        private void FillSalesOrderByFilm(int codsec)
        {
            ...
            if (lstSalesOrder.Count > 0)
            {
                for (int i = 0; i < lstSalesOrder.Count; i++)
                {
                    ...
                    dgvSalesOrder.Rows[i].Cells[clmsalesisinternational.Index].Value = (lstSalesOrder[i].isInternationalSale == true) ? global::BPS.Lite.Properties.Resources.world : global::BPS.Lite.Properties.Resources.table;
        ...
        {
            e.Row.Cells[clmsalesisinternational.Index].Value = global::BPS.Lite.Properties.Resources.table;
        ...
        private void PopulateSumary()
        {
            ...
            for (int i = 0; i < lstMetalizeOrder.Count; i++)
            {
                ...
                dgvSummary.Rows[i].Cells[cclmsummarystatus.Index].Value = (lstMetalizeOrder[i].fkStatus == 46) ? global::BPS.Lite.Properties.Resources.control_stop : (lstMetalizeOrder[i].fkStatus == 1066) ? global::BPS.Lite.Properties.Resources.control_play : global::BPS.Lite.Properties.Resources.control_pause;
                ...
                dgvSummary.Rows[i].Cells[clmsummarycancel.Index].Value = global::BPS.Lite.Properties.Resources.cross;
                dgvSummary.Rows[i].Cells[clmsummaryedit.Index].Value = global::BPS.Lite.Properties.Resources.pencil;
            }
        }
        ...
        private void dgvSalesOrder_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == clmsalesproduct.Index)
            {
                ...
                if (selectedProductCodsec > 0)
                {
                    ...
                    dgvSalesOrder.CurrentRow.Cells[clmsalesisinternational.Index].Value = global::BPS.Lite.Properties.Resources.table;
