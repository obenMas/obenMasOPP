    ...
    public partial class frmMovementReportbyDate : Form
    {
        ...
        private void dtpDate_ValueChanged(object sender, EventArgs e)
        {
            if (cmbMovementType.SelectedIndex > -1)
            {
                ...
                lstPalletbyCoilCellar = clsPalletbyCoilCellar.getListMovement(Convert.ToDateTime(initdate), Convert.ToDateTime(enddate), (((clsCoilCellarMovement)cmbMovementType.SelectedItem).codsec));
        ...
        private void FillDataMovementType()
        {
            ...
            {
                if (lstCoilCellarMovement[i].codsec == 2)
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMovementReportbyDateView winReport = new frmMovementReportbyDateView(Convert.ToDateTime(initdate), Convert.ToDateTime(enddate), (((clsCoilCellarMovement)cmbMovementType.SelectedItem).codsec));
                winReport.StartPosition = FormStartPosition.Manual;
