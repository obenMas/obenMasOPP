        ...
        private void dgvDetails_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.ColumnIndex == clmDetail.Index)
                {
                    ...
                    {
                        if (Convert.ToInt32(dgvDetails.Rows[e.RowIndex].Cells[clmfkRaw.Index].Value) != 0)
                        {
                    ...
                    {
                        if (!string.IsNullOrEmpty(dgvDetails.Rows[e.RowIndex].Cells[clmCodsec.Index].Value.ToString()))
                        {
