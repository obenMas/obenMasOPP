    ...
    public partial class frmFormulation : Form
    {
        ...
        private void L1DMT()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.layerC1)
                {
                    ...
                    dgvL1.Rows[dgvL1.Rows.Count - 1].Cells[l1delete.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
        ...
        private void L2DMT()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.layerC2)
                {
                    ...
                    dgvL2.Rows[dgvL2.Rows.Count - 1].Cells[l2del.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
        ...
        private void L3DMT()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.layerC3)
                {
                    ...
                    dgvL3.Rows[dgvL3.Rows.Count - 1].Cells[l3del.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
        ...
        private void L4DMT()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.layerC4)
                {
                    ...
                    dgvL4.Rows[dgvL4.Rows.Count - 1].Cells[l4del.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
        ...
        private void dgvL1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 10)
            {
                ...
                {
                    //Validar que el mismo pallet no esté en otras fórmulas
                    if (clsSummaryRM.validateToDeleteRow(dgvL1.Rows[e.RowIndex].Cells[l1fkraw.Index].Value.ToString(), fkFilmProduction))
                    {
                        if (clsRawMaterialExtruder.setDeleteTransferMR(dgvL1.Rows[e.RowIndex].Cells[l1fkraw.Index].Value.ToString()))
                        {
                            if (clsRawMaterialByFormulation.toDeleteMPCL(dgvL1.Rows[e.RowIndex].Cells[l1codsec.Index].Value.ToString(),
                                dgvL1.Rows[e.RowIndex].Cells[l1fkformulation.Index].Value.ToString(),
                                dgvL1.Rows[e.RowIndex].Cells[l1lot.Index].Value.ToString(), "L1"))
                            {
                                MessageBox.Show("Materia Prima Eliminada correctamente");
                                L1DMT();
                            }
                        ...
                        MessageBox.Show("El pallet " + dgvL1.Rows[e.RowIndex].Cells[l1code.Index].Value.ToString() + " no puede ser eliminado ya que se encuentra en otras fórmulas, Por favor comunicarse con sistemas");
                }
            }
        }
        #endregion
        ...
        private void dgvL2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 10)
            {
                ...
                {
                    //Validar que el mismo pallet no esté en otras fórmulas
                    if (clsSummaryRM.validateToDeleteRow(dgvL2.Rows[e.RowIndex].Cells[l2fkraw.Index].Value.ToString(), fkFilmProduction))
                    {
                        if (clsRawMaterialExtruder.setDeleteTransferMR(dgvL2.Rows[e.RowIndex].Cells[l2fkraw.Index].Value.ToString()))
                        {
                            if (clsRawMaterialByFormulation.toDeleteMPCL(dgvL2.Rows[e.RowIndex].Cells[l2codsec.Index].Value.ToString(),
                                dgvL2.Rows[e.RowIndex].Cells[l2fkfor.Index].Value.ToString(),
                                dgvL2.Rows[e.RowIndex].Cells[l2lot.Index].Value.ToString(), "L2"))
                            {
                                MessageBox.Show("Materia Prima Eliminada correctamente");
                                L2DMT();
                            }
                        ...
                        MessageBox.Show("El pallet " + dgvL2.Rows[e.RowIndex].Cells[l2code.Index].Value.ToString() + " no puede ser eliminado ya que se encuentra en otras fórmulas, Por favor comunicarse con sistemas");
                }
            }
        }
        #endregion
        ...
        private void dgvL3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 10)
            {
                ...
                {
                    //Validar que el mismo pallet no esté en otras fórmulas
                    if (clsSummaryRM.validateToDeleteRow(dgvL3.Rows[e.RowIndex].Cells[l3fkraw.Index].Value.ToString(), fkFilmProduction))
                    {
                        if (clsRawMaterialExtruder.setDeleteTransferMR(dgvL3.Rows[e.RowIndex].Cells[l3fkraw.Index].Value.ToString()))
                        {
                            if (clsRawMaterialByFormulation.toDeleteMPCL(dgvL3.Rows[e.RowIndex].Cells[l3codsec.Index].Value.ToString(),
                                dgvL3.Rows[e.RowIndex].Cells[l3fkfor.Index].Value.ToString(),
                                dgvL3.Rows[e.RowIndex].Cells[l3lot.Index].Value.ToString(), "L3"))
                            {
                                MessageBox.Show("Materia Prima Eliminada correctamente");
                                L3DMT();
                            }
                        ...
                        MessageBox.Show("El pallet " + dgvL3.Rows[e.RowIndex].Cells[l3code.Index].Value.ToString() + " no puede ser eliminado ya que se encuentra en otras fórmulas, Por favor comunicarse con sistemas");
                }
            }
        }
        #endregion
        ...
        private void dgvL4_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 10)
            {
                ...
                {
                    //Validar que el mismo pallet no esté en otras fórmulas
                    if (clsSummaryRM.validateToDeleteRow(dgvL4.Rows[e.RowIndex].Cells[l4fkraw.Index].Value.ToString(), fkFilmProduction))
                    {
                        if (clsRawMaterialExtruder.setDeleteTransferMR(dgvL4.Rows[e.RowIndex].Cells[l4fkraw.Index].Value.ToString()))
                        {
                            if (clsRawMaterialByFormulation.toDeleteMPCL(dgvL4.Rows[e.RowIndex].Cells[l4codsec.Index].Value.ToString(),
                                dgvL4.Rows[e.RowIndex].Cells[l4fkfor.Index].Value.ToString(),
                                dgvL4.Rows[e.RowIndex].Cells[l4lot.Index].Value.ToString(), "L4"))
                            {
                                MessageBox.Show("Materia Prima Eliminada correctamente");
                                L4DMT();
                            }
                        ...
                        MessageBox.Show("El pallet " + dgvL4.Rows[e.RowIndex].Cells[l4code.Index].Value.ToString() + " no puede ser eliminado ya que se encuentra en otras fórmulas, Por favor comunicarse con sistemas");
                }
            }
        }
        #endregion
        ...
        private void ExtPrimaryMW()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.CentralLayer)
                {
                    ...
                    dgvCLMW.Rows[dgvCLMW.Rows.Count - 1].Cells[extdel.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
        ...
        private void S1MW()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.layerC1)
                {
                    ...
                    dgvS1.Rows[dgvS1.Rows.Count - 1].Cells[s1del.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
        ...
        private void S2MW()
        {
            ...
            foreach (var item in rawList)
            {
                if (item.layerC2)
                {
                    ...
                    dgvS2.Rows[dgvS2.Rows.Count - 1].Cells[s2del.Index].Value = global::BPS.Raw.Properties.Resources.cross;
                }
            }
        }
